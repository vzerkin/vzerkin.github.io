...
* Auxiliary tools online:
    * Translate your ENSDF file to MyEnsdf.json (and vice versa)
...
* Editor and auxiliary tools can also be used in local Web-Browser without Web-server.
